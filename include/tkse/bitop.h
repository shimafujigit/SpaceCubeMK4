 ...
 */
IMPORT BOOL	BitTest( void *base, UW offset );
 ...
 */
IMPORT W	BitSearch0( void *base, W offset, W width ); /* Retrieve bit 0 */
IMPORT W	BitSearch1( void *base, W offset, W width ); /* Retrieve bit 1 */
