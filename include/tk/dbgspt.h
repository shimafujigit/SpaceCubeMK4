 ...
 */
#if (defined(USE_DBGSPT)&&(USE_DBGSPT))
...
#define td_lst_sem( p_list, nent )		( E_RSFN )
#define td_lst_flg( p_list, nent )		( E_RSFN )
#define td_lst_mbx( p_list, nent )		( E_RSFN )
#define td_lst_mtx( p_list, nent )		( E_RSFN )
#define td_lst_mbf( p_list, nent )		( E_RSFN )
#define td_lst_por( p_list, nent )		( E_RSFN )
#define td_lst_mpf( p_list, nent )		( E_RSFN )
#define td_lst_mpl( p_list, nent )		( E_RSFN )
#define td_lst_cyc( p_list, nent )		( E_RSFN )
#define td_lst_alm( p_list, nent )		( E_RSFN )
#define td_lst_ssy( p_list, nent )		( E_RSFN )

/* Refer each object state */
#define td_ref_sem( semid, p_rsem )		( E_RSFN )
#define td_ref_flg( flgid, p_rflg )		( E_RSFN )
#define td_ref_mbx( mbxid, p_rmbx )		( E_RSFN )
#define td_ref_mtx( mtxid, p_rmtx )		( E_RSFN )
#define td_ref_mbf( mbfid, p_rmbf )		( E_RSFN )
#define td_ref_por( porid, p_rpor )		( E_RSFN )
#define td_ref_mpf( mpfid, p_rmpf )		( E_RSFN )
#define td_ref_mpl( mplid, p_rmpl )		( E_RSFN )
#define td_ref_cyc( cycid, p_rcyc )		( E_RSFN )
#define td_ref_alm( almid, p_ralm )		( E_RSFN )
#define td_ref_ssy( ssid, p_rssy )		( E_RSFN )

/* Refer task state */
#define td_ref_tsk( tskid, p_rtsk )		( E_RSFN )
#define td_ref_tex( tskid, p_rtex )		( E_RSFN )
#define td_inf_tsk( tskid, p_itsk, clr )	( E_RSFN )
#define td_get_reg( tskid, p_regs, p_eit, p_cregs )	( E_RSFN )
#define td_set_reg( tskid, p_regs, p_eit, p_cregs )	( E_RSFN )

/* Refer system state */
#define td_ref_sys( p_rsys )			( E_RSFN )
#define td_get_tim( p_tim, p_ofs )		( E_RSFN )
#define td_get_otm( p_tim, p_ofs )		( E_RSFN )

/* Refer ready queue */
#define td_rdy_que( pri, p_list, nent )		( E_RSFN )

/* Refer wait queue */
#define td_sem_que( semid, p_list, nent )	( E_RSFN )
#define td_flg_que( flgid, p_list, nent )	( E_RSFN )
#define td_mbx_que( mbxid, p_list, nent )	( E_RSFN )
#define td_mtx_que( mtxid, p_list, nent )	( E_RSFN )
#define td_smbf_que( mbfid, p_list, nent )	( E_RSFN )
#define td_rmbf_que( mbfid, p_list, nent )	( E_RSFN )
#define td_cal_que( porid, p_list, nent )	( E_RSFN )
#define td_acp_que( porid, p_list, nent )	( E_RSFN )
#define td_mpf_que( mpfid, p_list, nent )	( E_RSFN )
#define td_mpl_que( mplid, p_list, nent )	( E_RSFN )

/* Execution trace */
#define td_hok_svc( p_hsvc )			( E_RSFN )
#define td_hok_dsp( p_hdsp )			( E_RSFN )
#define td_hok_int( p_hint )			( E_RSFN )

/* Object name */
#define td_ref_dsname( type, id, p_dsname )	( E_RSFN )
#define td_set_dsname( type, id, p_dsname )	( E_RSFN )

/* T-Kernel 2.0 */
#define td_ref_cyc_u( cycid, p_rcyc_u )		( E_RSFN )
#define td_ref_alm_u( almid, p_ralm_u )		( E_RSFN )
#define td_ref_tsk_u( tskid, p_rtsk_u )		( E_RSFN )
#define td_inf_tsk_u( tskid, p_itsk_u, clr )	( E_RSFN )
#define td_get_tim_u( p_tim_u, p_ofs )		( E_RSFN )
#define td_get_otm_u( p_tim_u, p_ofs )		( E_RSFN )
