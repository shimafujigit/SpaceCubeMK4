...
err_ret2:
	Vfree(shdr_buf);
err_ret1:
	BMS_DEBUG_PRINT(("GetELFLoadInfoShdr ercd = %d\n", er));
	return er;
}
...
err_ret2:
	Vfree(phdr_buf);
err_ret1:
	BMS_DEBUG_PRINT(("HasDynSeg ercd = %d\n", er));
	return FALSE;
}
...
err_ret2:
	Vfree(shdr_buf);
err_ret1:
	BMS_DEBUG_PRINT(("HasRelSec ercd = %d\n", er));
	return FALSE;
}
...
err_ret2:
	Vfree(phdr_buf);
err_ret1:
	BMS_DEBUG_PRINT(("GetELFLoadInfoPhdr ercd = %d\n", er));
	return er;
}
...
err_ret:
	BMS_DEBUG_PRINT(("GetELFLoadInfo ercd = %d\n", er));
	return er;
}
...
err_ret:
	BMS_DEBUG_PRINT(("elf_get_gp ercd = %d\n", er));
	return er;
}
#endif
...
err_ret2:
	Vfree(symtbl);
err_ret1:
	BMS_DEBUG_PRINT(("elf_relocation ercd = %d\n", er));
	return er;
}
...
err_ret1:
	BMS_DEBUG_PRINT(("elf_load ercd = %d\n", er));
	return er;
}
