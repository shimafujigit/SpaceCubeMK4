...
/* ASCII tables for charcscter check */
IMPORT const	UB	fatEncAsciiLowToUpTable[];
IMPORT const	UB	fatEncAsciiUpToLowTable[ASCII_MAX + 1];
IMPORT const	UB	fatEncAsciiIsLowTable[ASCII_MAX + 1];
IMPORT const	UB	fatEncAsciiAllowTable[ASCII_MAX + 1];

#define AsciiToUP(ascii)	fatEncAsciiLowToUpTable[(ascii) & ASCII_MAX]
#define AsciiToLOW(ascii)	fatEncAsciiUpToLowTable[(ascii) & ASCII_MAX]

#define getAsciiKind(ascii)	fatEncAsciiIsLowTable[(ascii)]
...
#define AsciiIsSFN(ascii)	((fatEncAsciiAllowTable[(ascii)] & 0x1) == 0x1)
#define AsciiIsLFN(ascii)	((fatEncAsciiAllowTable[(ascii)] & 0x2) == 0x2)
