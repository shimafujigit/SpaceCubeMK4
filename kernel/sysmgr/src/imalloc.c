 ...
 */
#pragma inline(PageCount)
static size_t PageCount( size_t size )
{
 ...
 */
#pragma inline(mem_alloc)
static void* mem_alloc( QUEUE *aq, size_t blksz, IMACB *imacb )
{
	QUEUE	*q;
...
#if	USE_MEM_PROTECT
	initIMACB(TA_RNG2);
	initIMACB(TA_RNG2|TA_NORESIDENT);
#else
	initIMACB(TA_RNG3);
