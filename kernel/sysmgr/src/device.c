...
#if defined(USE_FUNC_DEVMGRLOCK)
/* Lock for device management exclusive control */
EXPORT	FastMLock	DevMgrLock;
#endif /* USE_FUNC_DEVMGRLOCK */

#if defined(USE_FUNC_DEVMGRSYNC)
/* Semaphore for device management synchronous control */
EXPORT	ID		DevMgrSync;
#endif /* USE_FUNC_DEVMGRSYNC */

#if defined(USE_FUNC_INITIALIZE_DEVMGR)||defined(USE_FUNC_FINISH_DEVMGR)||defined(USE_FUNC_TK_DEF_DEV)||defined(USE_FUNC_TK_REF_IDV)
/* Device initial setting information */
LOCAL	T_IDEV		DefaultIDev;
#endif /* USE_FUNC_INITIALIZE_DEVMGR or USE_FUNC_FINISH_DEVMGR or USE_FUNC_TK_DEF_DEV  or USE_FUNC_TK_REF_IDV */
...
#if defined(USE_FUNC_INITIALIZE_DEVMGR)
/*
...
#if defined(USE_FUNC_FINISH_DEVMGR)
/*
...
#if defined(USE_FUNC_TK_GET_DEV)||defined(USE_FUNC_TK_EVT_DEV)
/*
 * Verify validity of device ID
 */
#pragma inline(check_devid)
static ER check_devid( ID devid )
{
	devid >>= 8;
...
#endif /* USE_FUNC_TK_GET_DEV or USE_FUNC_TK_EVT_DEV */
...
#if defined(USE_FUNC_SEARCHDEVCB)
/*
...
#if defined(USE_FUNC_TK_DEF_DEV)
/*
...
#if defined(USE_FUNC_TK_REF_IDV)
/*
...
#if defined(USE_FUNC_TK_GET_DEV)
/*
...
#if defined(USE_FUNC_TK_REF_DEV)
/*
...
#if defined(USE_FUNC_TK_OREF_DEV)
/*
 * Get device information
 */
...
#if defined(USE_FUNC_TK_LST_DEV)
/*
...
#if defined(USE_FUNC_TK_EVT_DEV)
/*
