...
#if defined(NUM_OPNDEV)

#if defined(USE_FUNC_INITDEVIO)||defined(USE_FUNC_FINISHDEVIO)||defined(USE_FUNC_TK_OPN_DEV)||defined(USE_FUNC_CHECK_DEVDESC)||defined(USE_FUNC_TK_CLS_DEV)||defined(USE_FUNC_DEVMGR_CLEANUP)
LOCAL	OpnCB	*OpnCBtbl;	/* Open management information table */
LOCAL	QUEUE	FreeOpnCB;	/* Unused queue */
#endif /* USE_FUNC_INITDEVIO or USE_FUNC_FINISHDEVIO or USE_FUNC_TK_OPN_DEV or USE_FUNC_CHECK_DEVDESC or USE_FUNC_TK_CLS_DEV or USE_FUNC_DEVMGR_CLEANUP */
LOCAL	INT	MaxOpnDev;	/* Maximum number of devices open */

#define DD(opncb)		( (opncb) - OpnCBtbl + 1 )
#define OPNCB(dd)		( OpnCBtbl + ((dd) - 1) )

#if defined(USE_FUNC_DEVMGR_CLEANUP)||defined(USE_FUNC_FINISHDEVIO)||defined(USE_FUNC_INITDEVIO)||defined(USE_FUNC_TK_CLS_DEV)||defined(USE_FUNC_TK_REA_DEV)||defined(USE_FUNC_TK_SREA_DEV)||defined(USE_FUNC_TK_SWRI_DEV)||defined(USE_FUNC_TK_WAI_DEV)||defined(USE_FUNC_TK_WRI_DEV)
LOCAL	ReqCB	*ReqCBtbl;	/* Request management information table */
LOCAL	QUEUE	FreeReqCB;	/* Unused queue */
#endif /* USE_FUNC_DEVMGR_CLEANUP or USE_FUNC_FINISHDEVIO or USE_FUNC_INITDEVIO or USE_FUNC_TK_CLS_DEV or USE_FUNC_TK_REA_DEV or USE_FUNC_TK_SREA_DEV or USE_FUNC_TK_SWRI_DEV or USE_FUNC_TK_WAI_DEV or USE_FUNC_TK_WRI_DEV */
...
#if defined(USE_FUNC_TK_OPN_DEV)||defined(USE_FUNC_TK_SUS_DEV)||defined(USE_FUNC_DEVMGR_BREAK)
/*
...
#endif /* USE_FUNC_TK_OPN_DEV or USE_FUNC_TK_SUS_DEV or USE_FUNC_DEVMGR_BREAK */

#if defined(USE_FUNC_CHECK_DEVDESC)
/*
...
#if defined(USE_FUNC_TK_OPN_DEV)||defined(USE_FUNC_TK_CLS_DEV)||defined(USE_FUNC_DEVMGR_CLEANUP)
/*
...
#endif /* USE_FUNC_TK_OPN_DEV or USE_FUNC_TK_CLS_DEV or USE_FUNC_DEVMGR_CLEANUP */

#if defined(USE_FUNC_TK_REA_DEV)||defined(USE_FUNC_TK_SREA_DEV)||defined(USE_FUNC_TK_WRI_DEV)||defined(USE_FUNC_TK_SWRI_DEV)
/*
...
#if defined(USE_FUNC_TK_CLS_DEV)||defined(USE_FUNC_DEVMGR_CLEANUP)||defined(USE_FUNC_TK_REA_DEV)||defined(USE_FUNC_TK_SREA_DEV)||defined(USE_FUNC_TK_WRI_DEV)||defined(USE_FUNC_TK_SWRI_DEV)||defined(USE_FUNC_TK_SREA_DEV)||defined(USE_FUNC_TK_SWRI_DEV)||defined(USE_FUNC_TK_WAI_DEV)
/*
...
#endif /* USE_FUNC_TK_CLS_DEV or USE_FUNC_DEVMGR_CLEANUP or USE_FUNC_TK_REA_DEV or USE_FUNC_TK_SREA_DEV or USE_FUNC_TK_WRI_DEV or USE_FUNC_TK_SWRI_DEV or USE_FUNC_TK_SREA_DEV or USE_FUNC_TK_SWRI_DEV or USE_FUNC_TK_WAI_DEV */
/* ------------------------------------------------------------------------ */
...
#endif /* USE_FUNC_TK_OPN_DEV or USE_FUNC_CLOSE_DEVICE */
...
#if defined(USE_FUNC_TK_CLS_DEV)||defined(USE_FUNC_DEVMGR_CLEANUP)
/*
 * Abort all requests
 */
...
#endif /* USE_FUNC_TK_CLS_DEV or USE_FUNC_DEVMGR_CLEANUP */

#if defined(USE_FUNC_TK_CLS_DEV)
/*
 * Device close
 */
...
#endif /* USE_FUNC_TK_REA_DEV or USE_FUNC_TK_SREA_DEV or USE_FUNC_TK_WRI_DEV or USE_FUNC_TK_SWRI_DEV */
...
#if defined(USE_FUNC_TK_REA_DEV)
/*
...
#if defined(USE_FUNC_TK_SREA_DEV)
/*
...
#if defined(USE_FUNC_TK_WRI_DEV)
/*
...
#if defined(USE_FUNC_TK_SWRI_DEV)
/*
...
#if defined(USE_FUNC_TK_SUS_DEV)||defined(USE_FUNC_DEVMGR_CLEANUP)
/* Suspend disable request count */
LOCAL	INT	DisSusCnt;
#endif /* USE_FUNC_TK_SUS_DEV or USE_FUNC_DEVMGR_CLEANUP */

/* Maximum number of suspend disable request counts */
#define MAX_DISSUS	0x7fff

#if defined(USE_FUNC_TK_SUS_DEV)
/*
...
#endif
#else
	DEBUG_PRINT(("1. do_suspend -> tk_evt_ssy : SKIPPED\n"));
#endif /* USE_FUNC_TK_EVT_SSY */
...
#endif
#else
	DEBUG_PRINT(("4. do_suspend -> tk_evt_ssy : SKIPPED\n"));
#endif /* USE_FUNC_TK_EVT_SSY */
...
#else
	off_pow();			/* direct call */
	DEBUG_PRINT(("5. do_suspend -> off_pow\n"));
#endif /* USE_FUNC_TK_SET_POW */
...
#endif
#else
	DEBUG_PRINT(("6. do_suspend -> tk_evt_ssy : SKIPPED\n"));
#endif /* USE_FUNC_TK_EVT_SSY */
...
#endif
#else
	DEBUG_PRINT(("9. do_suspend -> tk_evt_ssy : SKIPPED\n"));
#endif /* USE_FUNC_TK_EVT_SSY */
	return ercd;
}
...
#if defined(USE_FUNC_DEVMGR_BREAK)
/*
...
#endif /* USE_FUNC_DEVMGR_BREAK */

#if defined(USE_FUNC_DEVMGR_STARTUP)
/*
...
#if defined(USE_FUNC_DEVMGR_CLEANUP)
/*
...
#if defined(USE_FUNC_FINISHDEVIO)
/*
