...
#if defined(USE_FUNC_MBFCB_TABLE)
/*
...
#if defined(USE_FUNC_MESSAGEBUFFER_INITIALIZE)
/*
...
#if defined(USE_FUNC_TK_SND_MBF)||defined(USE_FUNC_TK_RCV_MBF)
/*
...
#endif /* USE_FUNC_TK_SND_MBF or USE_FUNC_TK_RCV_MBF */
...
#if defined(USE_FUNC_MESSAGEBUFFER_GETNAME)
/*
