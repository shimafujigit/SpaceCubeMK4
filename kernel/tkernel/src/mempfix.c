...
#if defined(USE_FUNC_MPFCB_TABLE)
/*
...
#if defined(USE_FUNC_FIX_MEMORYPOOL_INITIALIZE)
/*
 ...
 */
#pragma inline(mempool_end)
static void* mempool_end( MPFCB *mpfcb )
{
...
#if defined(USE_FUNC_FIX_MEMORYPOOL_GETNAME)
/*
