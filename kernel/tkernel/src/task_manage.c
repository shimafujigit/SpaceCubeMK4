...
#if defined(USE_FUNC_TK_DEL_TSK)||defined(USE_FUNC_TK_EXD_TSK)
/*
 * Task deletion
...
#endif /* USE_FUNC_TK_DEL_TSK or USE_FUNC_TK_EXD_TSK */
...
#if defined(USE_FUNC_TK_EXT_TSK)||defined(USE_FUNC_TK_EXD_TSK)||defined(USE_FUNC_TK_TER_TSK)
/*
 * Task finalization
 *	Call from critical section
 */
...
#endif /* USE_FUNC_TK_EXT_TSK or USE_FUNC_TK_EXD_TSK or USE_FUNC_TK_TER_TSK */
...
#if defined(USE_FUNC_TASK_GETNAME)
/*
