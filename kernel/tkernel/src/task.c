...
#if defined(USE_FUNC_TASK_INITIALIZE)
/*
 * TCB Initialization
 */
...
#if defined(USE_FUNC_MAKE_DORMANT)
/*
...
#if defined(USE_FUNC_CHANGE_TASK_PRIORITY)||defined(USE_FUNC_ROTATE_READY_QUEUE)||defined(USE_FUNC_ROTATE_READY_QUEUE_RUN)
...
#endif /* USE_FUNC_CHANGE_TASK_PRIORITY or USE_FUNC_ROTATE_READY_QUEUE or USE_FUNC_ROTATE_READY_QUEUE_RUN */

#if defined(USE_FUNC_MAKE_READY)
/*
...
#if defined(USE_FUNC_MAKE_NON_READY)
/*
...
#if defined(USE_FUNC_CHANGE_TASK_PRIORITY)
/*
...
#if defined(USE_FUNC_ROTATE_READY_QUEUE)
/*
 * Rotate ready queue.
 */
...
#if defined(USE_FUNC_ROTATE_READY_QUEUE_RUN)
/*
