...
#if defined(USE_FUNC_TK_SLP_TSK)||defined(USE_FUNC_TK_WUP_TSK)
/*
 * Definition of task wait specification
 */
LOCAL CONST WSPEC wspec_slp = { TTW_SLP, NULL, NULL };
#endif /* USE_FUNC_TK_SLP_TSK or USE_FUNC_TK_WUP_TSK */
