...
#if defined(USE_FUNC_MBXCB_TABLE)
/*
...
#if defined(USE_FUNC_MAILBOX_INITIALIZE)
/*
 ...
 */
#pragma inline(queue_insert_mpri)
static void queue_insert_mpri( T_MSG_PRI *pk_msg, T_MSG *head )
{
	T_MSG_PRI	*msg;
	T_MSG		*prevmsg = head;
...
#if defined(USE_FUNC_MAILBOX_GETNAME)
/*
