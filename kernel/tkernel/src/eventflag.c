...
#if defined(USE_FUNC_FLGCB_TABLE)
/*
...
#if defined(USE_FUNC_EVENTFLAG_INITIALIZE)
/*
...
#if defined(USE_FUNC_TK_SET_FLG)||defined(USE_FUNC_TK_WAI_FLG)
/*
...
#endif /* USE_FUNC_TK_SET_FLG or USE_FUNC_TK_WAI_FLG */
...
#if defined(USE_FUNC_EVENTFLAG_GETNAME)
/*
