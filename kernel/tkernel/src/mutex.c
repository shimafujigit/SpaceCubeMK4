...
#if defined(USE_FUNC_MTXCB_TABLE)
#ifndef __mtxcb__
#define __mtxcb__
...
#if defined(USE_FUNC_MUTEX_INITIALIZE)
/*
...
#if defined(USE_FUNC_TK_DEL_MTX)||defined(USE_FUNC_TK_UNL_MTX)||defined(USE_FUNC_TK_LOC_MTX)
/*
...
#endif /* USE_FUNC_TK_DEL_MTX or USE_FUNC_TK_UNL_MTX or USE_FUNC_TK_LOC_MTX */

#if defined(USE_FUNC_SIGNAL_ALL_MUTEX)
/*
...
#if defined(USE_FUNC_CHG_PRI_MUTEX)
/*
...
#if defined(USE_FUNC_MUTEX_GETNAME)
/*
