...
#if defined(USE_FUNC_PORCB_TABLE)
/*
...
#if defined(USE_FUNC_RENDEZVOUS_INITIALIZE)
/*
...
#if defined(USE_FUNC_TK_CAL_POR)||defined(USE_FUNC_TK_ACP_POR)||defined(USE_FUNC_TK_FWD_POR)
/*
...
#endif /* USE_FUNC_TK_CAL_POR or USE_FUNC_TK_ACP_POR or USE_FUNC_TK_FWD_POR */

#if defined(USE_FUNC_TK_FWD_POR)||defined(USE_FUNC_TK_RPL_RDV)
/*
...
#endif /* USE_FUNC_TK_FWD_POR or USE_FUNC_TK_RPL_RDV */


#if defined(USE_FUNC_WSPEC_CAL)
/*
...
#if defined(USE_FUNC_RENDEZVOUS_GETNAME)
/*
