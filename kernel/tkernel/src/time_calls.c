...
#if defined(USE_FUNC_CYCCB_TABLE)
/*
...
#if defined(USE_FUNC_CYCLICHANDLER_INITIALIZE)
/*
...
#if defined(USE_FUNC_TK_CRE_CYC)||defined(USE_FUNC_TK_STA_CYC)||defined(USE_FUNC_TK_REF_CYC)||defined(USE_FUNC_TD_REF_CYC)
/*
 * Next startup time
 */
#pragma inline(cyc_next_time)
static LSYSTIM cyc_next_time( CYCCB *cyccb )
{
	LSYSTIM		tm;
	longlong	n;
...
#endif /* USE_FUNC_TK_CRE_CYC or USE_FUNC_TK_STA_CYC or USE_FUNC_TK_REF_CYC or USE_FUNC_TD_REF_CYC */

#if defined(USE_FUNC_TK_CRE_CYC)||defined(USE_FUNC_TK_STA_CYC)
LOCAL void call_cychdr( CYCCB* cyccb );

/*
 * Register timer event queue
 */
#pragma inline(cyc_timer_insert)
static void cyc_timer_insert( CYCCB *cyccb, LSYSTIM tm )
{
...
#endif /* USE_FUNC_TK_CRE_CYC or USE_FUNC_TK_STA_CYC */
...
#if defined(USE_FUNC_CYCLICHANDLER_GETNAME)
/*
...
#if defined(USE_FUNC_ALMCB_TABLE)
/*
...
#if defined(USE_FUNC_ALARMHANDLER_INITIALIZE)
/*
...
#if defined(USE_FUNC_CALL_ALMHDR)
/*
 ...
 * Register onto timer event queue
 */
#pragma inline(alm_timer_insert)
static void alm_timer_insert( ALMCB *almcb, RELTIM_U reltim )
{
	LSYSTIM	tm;
...
#if defined(USE_FUNC_ALARMHANDLER_GETNAME)
/*
 * Get object name from control block
 */
#if USE_OBJECT_NAME
