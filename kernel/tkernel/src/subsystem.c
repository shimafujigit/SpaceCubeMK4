...
#if defined(USE_FUNC_SSYCB_TABLE)
/*
...
#if defined(USE_FUNC_RESOURCE_GROUP_INITIALIZE)||defined(USE_FUNC_TK_CRE_RES)||defined(USE_FUNC_TK_DEL_RES)||defined(USE_FUNC_TK_GET_RES)
/*
 * Bitmap of use resource ID
 *	If the bit corresponding to the resource ID is 1, it is in use.
 */
LOCAL UB *resid_bitmap;
#endif /* USE_FUNC_RESOURCE_GROUP_INITIALIZE or USE_FUNC_TK_CRE_RES or USE_FUNC_TK_DEL_RES or USE_FUNC_TK_GET_RES */
...
#if defined(USE_FUNC_SUBSYSTEM_INITIALIZE)
/*
...
#if defined(USE_FUNC_SVC_IENTRY)
/*
...
#endif /* USE_FUNC_TK_DEF_TEX */

#if defined(USE_FUNC_TK_DIS_TEX)||defined(USE_FUNC_TK_ENA_TEX)
/*
...
#endif /* USE_FUNC_TK_DIS_TEX or USE_FUNC_TK_ENA_TEX */
...
#endif /* USE_FUNC_TK_ENA_TEX */


#if defined(USE_FUNC_CALL_BRKHDR)
/*
 * Call break function
...
#if defined(USE_FUNC_RESOURCE_GROUP_INITIALIZE)
/*
...
#endif /* USE_FUNC_RESOURCE_GROUP_INITIALIZE */
