...
err_ret:
	BMS_DEBUG_PRINT(("_GetSpaceInfo ercd = %d\n", ercd));
	return ercd;
}
...
err_ret:
	BMS_DEBUG_PRINT(("_MapMemory ercd = %d\n", ercd));
	return ercd;
}
...
err_ret:
	BMS_DEBUG_PRINT(("_UnmapMemory ercd = %d\n", ercd));
	return ercd;
}
...
err_ret:
	BMS_DEBUG_PRINT(("_FlushMemCache ercd = %d\n", ercd));
	return ercd;
}
...
err_ret:
	BMS_DEBUG_PRINT(("_ControlCache ercd = %d\n", ercd));
	return ercd;
}
...
#ifdef DEBUG
	if ( ret < E_OK ) {
		BMS_DEBUG_PRINT(("finish_segmgr ercd = %d\n", ret));
	}
#endif
	return ret;
}
