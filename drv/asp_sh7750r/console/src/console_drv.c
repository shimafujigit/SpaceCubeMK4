...
/*
 *	Input from the console port :"return":
 *		the number of the characters actually injput
 */
...
static	union objname	name = {{ "con0" }};
	...
	if ((p->flg = CreLock(&p->lock, (UB*)name.s)) < 0) goto EEXIT;
