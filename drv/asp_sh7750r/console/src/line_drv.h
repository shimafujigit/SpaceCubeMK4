...
#define	DEF_INBUFSZ	64//2048	/* Standard receive-buffer size	*/
#define	MIN_INBUFSZ	64//256	/* Minimum receive-buffer size	*/
#define OUBUFSZ		32//512	/* Send-buffer size:Fixed	*/
...
typedef	struct {
	...
	UW	hwrsrcv:1;	/* H/W RS control recover flag */
} FlowState;
