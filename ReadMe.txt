 ...
 *
 *    Version:   1.00.01
 *    Released by UC Technology (http://www.uctec.com/) at 2023/4/7.
 *
 *----------------------------------------------------------------------
 */
...
------------------------------------------------------------------------------
    ...
    ASP_LEON5.zip               Eclipse プロジェクト一式
...
Eclipse プロジェクト一式のアーカイブファイルである ASP_LEON5.zip を任意のデ
ィレクトリ上で展開してください。展開すると ASP_LEON5 フォルダが現れます。

(注) 展開したとき、展開方法により ASP_LEON5\ASP_LEON5\ と２段になってしまう
     場合がありますが、最後(一番右)の ASP_LEON5 フォルダを使用します。

Eclipse を起動し、Workspace として ASP_LEON5 フォルダを指定します。

メニューの File - Open Projects from File System... を選択します。
Import source の Directory... を押し、ASP_LEON5 フォルダを選択します。
Folder にプロジェクトの一覧が表示されているのを確認して、Finish を押します。

Project Explorer に以下のようなプロジェクトの一覧が表示されていることを確認
してください。
...
最後に usermain プロジェクトをビルドして生成される usermain が実行プログラム
になります。
